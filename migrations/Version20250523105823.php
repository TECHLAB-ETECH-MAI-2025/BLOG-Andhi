 ...
 */
final class Version20250523105823 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE article ADD author_id INT NOT NULL, DROP user_id
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE article ADD user_id INT DEFAULT NULL, DROP author_id
        SQL);
        $this->addSql(<<<'SQL'
